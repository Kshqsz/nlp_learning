...
- **fp16 混合精度**：NVIDIA GPU 推荐，加速训练、节省显存
- **多进程数据加载**：`dataloader_num_workers=4` 充分利用 CPU
...
```
🚀 Starting Chinese continued pretraining on NVIDIA 4090D...
...
- 推荐：NVIDIA GPU (4090D / 4090 / 3090 等，24GB 显存)
- 最低：支持 CUDA 的 GPU，8GB 显存（需调小 batch_size）
